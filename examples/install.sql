...
CREATE TABLE object_type(
  object_type_id   INTEGER GENERATED BY DEFAULT ON NULL  AS IDENTITY,
...
CREATE TABLE relation_type(
  relation_type_id    INTEGER GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE object(
  ...
  data           CLOB,   -- JSON not supported by Oracle19c
  CONSTRAINT object_pk PRIMARY KEY (object_id),
  CONSTRAINT object_ck1 CHECK ( data IS JSON(STRICT) )
);

CREATE TABLE relation(
  relation_id         INTEGER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  created_at          DATE DEFAULT CURRENT_DATE NOT NULL,
...
CREATE TABLE dataitem(
  dataitem_id      INTEGER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  dataitem_name    VARCHAR2(30) NOT NULL,
  data             CLOB, -- JSON not supported by oracle19c,
  CONSTRAINT dataitem_pk PRIMARY KEY (dataitem_id)
);
